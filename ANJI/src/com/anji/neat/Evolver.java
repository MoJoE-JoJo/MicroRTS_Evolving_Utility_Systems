...
public class Evolver implements Configurable {
    ...
    public void init(Properties props) throws Exception {
        ...
        if (genotype != null) {
            ...
            String baselinePath = props.getProperty("utility.system.baseline", "");
            if (!baselinePath.equals("")) {
                // load our baseline file
                InputStream targetStream = new FileInputStream(baselinePath);
    ...
    public static void main(String[] args) throws Throwable {
        try {
            ...
            String abc = "ttt.properties";
            Properties props = new Properties(abc);
